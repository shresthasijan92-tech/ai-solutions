...
export const projects: Project[] = [
  { id: 'p1', title: 'E-commerce Recommendation Engine', description: 'Increased customer engagement and sales by 20% with a personalized product recommendation system.', imageId: 'project-1', technologies: ['Python', 'TensorFlow', 'Firebase'], featured: true, link: '/projects/p1' },
  { id: 'p2', title: 'Predictive Maintenance for Manufacturing', description: 'Reduced equipment downtime by 30% by predicting failures before they happen.', imageId: 'project-2', technologies: ['SCIKIT-LEARN', 'Pandas', 'Next.js'], featured: true, link: '/projects/p2' },
  { id: 'p3', title: 'Automated Customer Support Chatbot', description: 'Improved customer satisfaction by providing instant, 24/7 support and resolving 80% of inquiries.', imageId: 'project-3', technologies: ['Google Dialogflow', 'Node.js', 'React'], featured: true, link: '/projects/p3' },
  { id: 'p4', title: 'Retail Foot-Traffic Analysis', description: 'Optimized store layouts and marketing campaigns using computer vision to analyze customer behavior.', imageId: 'project-4', technologies: ['OpenCV', 'YOLO', 'Google Cloud'], featured: false, link: '/projects/p4' },
];

export const articles: Article[] = [
  { id: 'a1', title: 'The Generative AI Revolution: What It Means for Your Business', excerpt: 'Explore how generative AI is reshaping industries and how you can leverage it for a competitive edge.', imageId: 'blog-1', publishedAt: '2024-07-15', featured: true },
  { id: 'a2', title: '5 Common Pitfalls to Avoid in Your Next Machine Learning Project', excerpt: 'Learn from common mistakes to ensure your ML projects are successful and deliver real value.', imageId: 'blog-2', publishedAt: '2024-06-28', featured: true },
  { id: 'a3', title: 'An Introduction to Genkit and the Future of AI Development', excerpt: 'A deep dive into Google\'s new Genkit framework and how it simplifies building AI-powered applications.', imageId: 'blog-3', publishedAt: '2024-06-10', featured: true },
];

export const galleryImages: GalleryImage[] = [
  { id: 'g1', title: 'Team Collaboration', imageId: 'gallery-1', featured: true },
  { id: 'g2', title: 'Office Environment', imageId: 'gallery-2', featured: true },
  { id: 'g3', title: 'AI Conference Talk', imageId: 'gallery-3', featured: true },
  { id: 'g4', title: 'Data Insights', imageId: 'gallery-4', featured: false },
  { id: 'g5', title: 'Robotics Lab', imageId: 'gallery-5', featured: false },
  { id: 'g6', title: 'Pair Programming', imageId: 'gallery-6', featured: false },
];
